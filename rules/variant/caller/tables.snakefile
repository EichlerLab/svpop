...
rule variant_tables_caller_xlsx:
    input:
        tab='results/variant/{sourcetype}/{sourcename}/tables/{sample}/{svset}/{filter}/variant_summary/{vartype}_{svtype}.tab'
    output:
        xlsx='results/variant/{sourcetype}/{sourcename}/tables/{sample}/{svset}/{filter}/variant_summary/{vartype}_{svtype}.xlsx'
    run:
...
rule variant_tables_caller_summary_snv:
    input:
        bed='results/variant/{sourcetype}/{sourcename}/bed/{sample}/{svset}/{filter}/byref/snv_snv.bed'
    output:
        tab='results/variant/{sourcetype}/{sourcename}/tables/{sample}/{svset}/{filter}/variant_summary/snv_snv.tab'
    run:
