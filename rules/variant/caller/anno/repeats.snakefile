...
rule variant_anno_repeat_rmsk_table:
    input:
        ...
        out='results/variant/caller/{caller}/anno/{sample}/all/{filter}/rmsk/data/rmsk-table_{vartype}_{svtype}/rmsk.out'
    output:
        tab='results/variant/caller/{caller}/anno/{sample}/all/{filter}/rmsk/rmsk-table_{vartype}_{svtype,ins|del|inv|dup}.tab'
    run:
...
rule variant_anno_repeat_rmsk_run:
    input:
        fasta='results/variant/caller/{caller}/fasta/{sample}/all/{filter}/{vartype}_{svtype}.fa.gz'
    output:
        out='results/variant/caller/{caller}/anno/{sample}/all/{filter}/rmsk/data/rmsk-table_{vartype}_{svtype}/rmsk.out'
...
rule variant_anno_repeat_trf_table:
    input:
        out='results/variant/caller/{caller}/anno/{sample}/all/{filter}/trf/data/trf-table_{vartype}_{svtype}/trf.out'
    output:
        tab='results/variant/caller/{caller}/anno/{sample}/all/{filter}/trf/trf-table_{vartype}_{svtype}.tab'
    wildcard_constraints:
...
rule variant_anno_repeat_trf_run:
    input:
        fa='temp/variant/caller/{caller}/fasta/{sample}/all/{filter}/{vartype}_{svtype}.fa'
    output:
        out='results/variant/caller/{caller}/anno/{sample}/all/{filter}/trf/data/trf-table_{vartype}_{svtype}/trf.out'
    wildcard_constraints:
        svtype='ins|del|inv|dup|rgn|sub'
